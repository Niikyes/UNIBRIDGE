...
start cmd /k "cd /d C:\Users\Nicole\Desktop\Programacion Distribuida\UNIBRIDGE\backend\domains\student_management\user-get-profile-service && uvicorn app.main:app --reload --port 3021""
